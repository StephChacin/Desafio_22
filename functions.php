...
function lawyeriax_scripts_styles() {
	...
	// código que agregué 
	wp_enqueue_style( 'custom_style', get_parent_theme_file_uri('/css/custom.css'), null, null, null );
	wp_enqueue_style( 'custom_style', "https://fonts.googleapis.com/css?family=Lato", null, null, null );
